...
A ROS implementation of [IRAF-SLAM] that focuses on the ROS part.
...
```
cd ~/catkin_ws/src
git clone https://github.com/thanhnguyencanh/iraf_slam.git
cd ../
catkin build
```
...
```
# In one terminal:
roslaunch iraf_slam_ros ntuviral_mono.launch
# In another terminal:
...
```
# In one terminal:
roslaunch iraf_slam_ros kitti_stereo.launch
# In another terminal:
...
```
# In one terminal:
roslaunch iraf_slam_ros euroc_mono_inertial.launch
# In another terminal:
...
```
# In one terminal:
roslaunch iraf_slam_ros tum_vi_stereo_inertial.launch
# In another terminal:
...
```
# In one terminal:
roslaunch iraf_slam_ros tum_rgbd.launch
# In another terminal:
...
```
# In one terminal:
roslaunch iraf_slam_ros rs_d435i_rgbd_inertial.launch.launch
# In another terminal:
...
# In another terminal:
roslaunch iraf_slam_ros rs_t265_stereo_inertial.launch
```
